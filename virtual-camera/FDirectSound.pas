...
uses
  Winapi.Windows, Winapi.MMSystem, FDXTypes;
...
type
  D3DVALUE = FDXTypes.D3DVALUE;
  TD3DValue = FDXTypes.TD3DValue;
  PD3DValue = FDXTypes.PD3DValue;

  D3DCOLOR = FDXTypes.D3DCOLOR;
  TD3DColor = FDXTypes.TD3DColor;

  _D3DVECTOR = FDXTypes._D3DVECTOR;
  D3DVECTOR = FDXTypes.D3DVECTOR;
  TD3DVector = FDXTypes.TD3DVector;
  PD3DVector = FDXTypes.PD3DVector;
...
type
  REFERENCE_TIME = FDXTypes.REFERENCE_TIME;
  TReferenceTime = FDXTypes.TReferenceTime;
  PReferenceTime = FDXTypes.PReferenceTime;
